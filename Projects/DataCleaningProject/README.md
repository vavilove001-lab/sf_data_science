...
* [Павел Вавилов](vavi-love.ru)

## Выводы

В результате выполнения данного проекта, освоены методы работы в Pandas, приемы визуализации данных, оформление проекта в Markdown и углублены знания в публикации проекта на Gthub